    ...
    "
          ...
          "
                ...
                <button
                  ...
                  className="w-fit px-6 py-2 mt-4 rounded-full bg-[var(--green)]  border-2 border-[var(--green)] text-button text-[#fff] hover:bg-[var(--ter)] hover:text-[var(--prime)] transition"
                >
               Get A Quote
                </button>
