    ...
    "
          ...
          "
                ...
                <button
                  ...
                  className="w-fit px-6 py-2 mt-4 rounded-full bg-[var(--prime)]  border-2 border-[var(--prime)] text-button text-[#fff] hover:bg-[var(--ter)] hover:text-[var(--prime)] transition"
                >
                  Get a Code
                </button>
