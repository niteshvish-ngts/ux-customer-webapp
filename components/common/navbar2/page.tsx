    ...
    <header className="relative z-[100] w-full border-b border-border bg-white">
      <div className="container mx-auto px-4">
        <div className="flex h-20 items-center justify-between gap-6">
          ...
          {/* LEFT: Back (mobile only) + Logo */}
          <div className="flex items-center gap-2 shrink-0 min-w-0">
            <button
              onClick={() => router.back()}
              className="flex md:hidden items-center justify-center p-2 -ml-2 text-muted-foreground hover:bg-gray-50 rounded-full transition"
              aria-label="Back"
            >
              <Image
          ...
          {/* CENTER: Location Dropdown + Search - hidden on mobile */}
          ...
          {/* RIGHT: Cart + User - on mobile only profile visible */}
